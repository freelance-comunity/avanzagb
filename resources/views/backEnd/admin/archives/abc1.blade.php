...
<h1>Expedientes ABC Capital Linea 1 <div class="btn-group"><a href="{{ url('admin/archives/create') }}" class="btn btn-primary pull-right btn-sm">CREAR NUEVO</a> <a data-toggle="modal" data-target="#charge_excel" class="btn btn-info pull-right btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i> CARGAR EXCEL</a></div> </h1>
...
<div class="table table-responsive">
    <table class="table table-inverse" id="archivesabc1">
        <thead>
            <tr class="bg-success">
